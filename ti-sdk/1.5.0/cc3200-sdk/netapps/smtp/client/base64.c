...
//!
//!
//! \param 	pcOutStr - pointer to output string
//!			pccInStr - Pointer to input string
//!			iLen - Lenght of input string
//!
//! return 0 on success else -1 on failure 
//
//****************************************************************************
long ConvertToBase64(char *pcOutStr, const char *pccInStr, int iLen)
{
